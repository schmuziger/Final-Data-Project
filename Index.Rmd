...
setwd('C:/Users/Schmuziger/Desktop/Assignment-3')
```
...
p <- ggplot(Spain_data, aes(Turnout, Unempl_rate_less25))
p + geom_point()
p1<-p + geom_point(aes(colour = Region)) 
p3 <- p1 + labs(y="Youth Unemployment", x= "Turnout")
p5 <- p3 + scale_y_continuous("Youth Unemployment",
                              limits=c(10,85),
                              breaks=seq(10, 85, 10))
p5
